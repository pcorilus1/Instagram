...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnCapture = findViewById(R.id.btnCapture);
...
//        queryPosts();
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (caption.isEmpty())
                {
                    Toast.makeText(MainActivity.this, "I need a caption please.", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (photoFile == null || ivPostImage.getDrawable() == null )
                {
                    Toast.makeText(MainActivity.this, "I need an image please.", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//        super.onActivityResult(requestCode,resultCode, data);
    ...
    private void savePost(String caption, ParseUser currUser, File photoFile) {
        Post post = new Post();
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null)
                {
                    Log.e(TAG, "OH NO! I CAN'T SAVE THIS POST!", e);
                    Toast.makeText(MainActivity.this, "OH NO! I CAN'T SAVE THIS POST!", Toast.LENGTH_SHORT).show();
                }
